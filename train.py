...
#2.Intra day task
#2.1 No specifictime
#"input_text" :  Remind me to remmember reading email tonight.
...
#2.2 Time specified
#"input_text" :  Remind me to remmember reading email at 10pm.
...
#"input_text" :  Assisatant note it down for me to prepare my cv next 2 week.
...
#<dow> (day of week) in range 1 - 7, which 1 is sunday,2 is monday (and so on), 7 is staturday. <totd> (time of the day) just follow:
